...
<head>
    ...
    <meta name="description" content="Julien Fouksmann">
    ...
    <title>Portfolio - Julien Fouksmann</title>
</head>
                ...
                <div class="col-md-10 col-lg-7 ">
                    <div class="banner-content">
                        ...
                        <p class="text-white text-uppercase text-center text-xs">
                            Meet <span>Julien Fouksmann</span>
                        </p>
        ...
        <div class="container">
            <div class="row align-self-center">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <ul class="footer-link list-unstyled ml-0 justify-content-end">
                        <li>
                            <i class="fa fa-mobile"></i> 06 61 45 33 09
                        </li>
                        <li>
